...
/** `_boolean` is a `boolean` type assertion function. If `value` is a
 * `boolean`, `_boolean` returns `value` as `boolean`. Otherwise, `_boolean`
 * throws a `TypeAssertionError`, including `name` in its `message`. */
